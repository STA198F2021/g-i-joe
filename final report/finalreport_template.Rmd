...
http://www.sthda.com/english/wiki/ggplot2-quick-correlation-matrix-heatmap-r-software-and-data-visualization. Psilocybin (magic mushrooms). Alcohol and Drug Foundation. (10 November 2021).
...
result<-tidy(fit_multi_age, conf.int=TRUE, exponentiate=TRUE)
print(result, n=25)
```
