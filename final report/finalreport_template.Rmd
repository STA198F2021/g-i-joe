...
result<-tidy(fit_multi_gender, conf.int=TRUE, exponentiate=TRUE)
print(result, n=25)
```
...
result<-tidy(fit_multi_edu, conf.int=TRUE, exponentiate=TRUE)
print(result, n=25)
```
...
result<-tidy(fit_multi_country, conf.int=TRUE, exponentiate=TRUE)
print(result, n=25)
```
...
result<-tidy(fit_multi_personality, conf.int=TRUE, exponentiate=TRUE)
print(result, n=25)
```
